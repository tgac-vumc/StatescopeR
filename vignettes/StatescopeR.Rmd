...
## Create scRNAseq reference/signature with 100 hvg for quick example
signature <- create_signature(scRNAseq, hvg_genes = TRUE, n_hvg_genes =  50L)

## select subset of genes for deconvolution
selected_genes <- select_genes(scRNAseq, 30L, 50L) # 30 genes from 50 hvg to
                                                    #   make it quick
...
expected fraction of the pancreatic islet cells (alpha, beta & 
gamma cells) together, but not their individual contributions.
