...
## Create scRNAseq reference/signature with 200 hvg for quick example
signature <- create_signature(scRNAseq, hvg_genes = TRUE, n_hvg_genes =  200L)

## select subset of genes for deconvolution
selected_genes <- select_genes(scRNAseq, 60L, 200L) # 60 genes from 200 hvg to
                                                    #   make it quick
