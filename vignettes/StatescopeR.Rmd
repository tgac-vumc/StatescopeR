...
## Create scRNAseq reference/signature with 500 hvg for quick example
signature <- create_signature(scRNAseq, hvg_genes = TRUE, n_hvg_genes =  500L)

## select subset of genes for deconvolution
selected_genes <- select_genes(scRNAseq, 100L, 500L) # 100 genes from 500 hvg to
                                                     #   make it quick
...
Statescope <- BLADE_deconvolution(signature, pseudobulk, selected_genes, prior,
    cores = 2L) # Reduce repitions for example
